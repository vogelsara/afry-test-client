...
export const CreateCompanyForm = () => {
    ...
    return (
        <form noValidate>
            <TextField id="company-name-input" label="Name" onChange={onNameChanged} value={name} />
            <Button variant="contained" color="primary" onClick={onSaveCompanyClicked} disabled={!canSave}>
                Save
            </Button>
        </form>
    )
